"""
Python script for an example training run with LSTM.
"""
...
# Define paths
CONFIG_PATH = "configs/example_config_lstm.yaml"
OUTPUT_DIR = "data/example_output/lstm"
RUN_DIR = os.path.join(OUTPUT_DIR, 'run_walker2d-v5_lstm_arch16-16_hidden16_2025')
